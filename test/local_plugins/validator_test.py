...
from bartender.local_plugins.config import CONFIG_NAME, ENTRY_POINT_KEY
...
class LocalPluginValidatorTest(unittest.TestCase):
    ...
    @patch('bartender.local_plugins.validator.LocalPluginValidator.validate_plugin_config', Mock())
    ...
    @patch('bartender.local_plugins.validator.LocalPluginValidator.validate_plugin_path',
    ...
    def test_validate_plugin_path_bad(self):
        self.assertRaises(PluginValidationError,
                          self.validator.validate_plugin_path,
                          '/path/to/non-existant/foo')

    def test_validate_plugin_path_none(self):
        self.assertRaises(PluginValidationError, self.validator.validate_plugin_path, None)
    ...
    def test_validate_plugin_config_none(self):
        self.assertRaises(PluginValidationError, self.validator.validate_plugin_config, None)
    ...
    def test_validate_entry_point_none_config_module(self):
        self.assertRaises(PluginValidationError, self.validator.validate_entry_point,
                          None, '/path/to/plugin')

    def test_validate_entry_point_none_path_to_plugin(self):
        self.assertRaises(PluginValidationError, self.validator.validate_entry_point, {}, None)

    def test_validate_entry_point_no_entry_point_key(self):
        self.assertRaises(PluginValidationError, self.validator.validate_entry_point,
                          Mock(spec=[]), '/path/to/plugin')
    ...
    def test_validate_entry_point_good_file(self):
        self.validator.validate_entry_point(Mock(PLUGIN_ENTRY='is_totally_a_file'),
                                            '/path/to/plugin')
    ...
    def test_validate_entry_point_good_package(self, isfile_mock):
        ...
        self.validator.validate_entry_point(Mock(PLUGIN_ENTRY='-m plugin'), '/path/to/plugin')
    ...
    def test_validate_plugin_environment_none_config(self):
        self.assertRaises(PluginValidationError, self.validator.validate_plugin_environment, None)
    ...
    def test_validate_plugin_environment_bad_environment(self):
        self.assertRaises(PluginValidationError, self.validator.validate_plugin_environment,
    ...
    def test_validate_plugin_environment_good(self):
        self.assertTrue(self.validator.validate_plugin_environment(
            Mock(ENVIRONMENT={'foo': 'bar'})))
    ...
    def test_validate_plugin_config_missing_required_key(self, load_config_mock):
        config_module = Mock(VERSION='0.0.1', PLUGIN_ENTRY='/path/to/entry.py',
                             spec=['VERSION', 'PLUGIN_ENTRY'])
        load_config_mock.return_value = config_module
        self.assertRaises(PluginValidationError,
                          self.validator.validate_plugin_config, '/path/to/beer.conf')

    @patch('bartender.local_plugins.validator.isfile', Mock(return_value=True))
    @patch('bartender.local_plugins.validator.LocalPluginValidator._load_plugin_config')
    def test_validate_plugin_config_good(self, load_config_mock):
        config_module = Mock(NAME='name', VERSION='0.0.1', PLUGIN_ENTRY='/path/to/entry.py',
    ...
    def test_validate_instances_and_args_none_config_module(self):
        self.assertRaises(PluginValidationError, self.validator.validate_instances_and_args, None)

    def test_validate_instances_and_args_both_none(self):
        config_module = Mock(spec=[])
        self.assertTrue(PluginValidationError,
